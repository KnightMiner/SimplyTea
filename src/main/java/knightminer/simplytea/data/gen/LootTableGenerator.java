...
public class LootTableGenerator extends LootTableProvider {
	private final Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootContextParamSet> lootTables = Pair.of(BlockLootTableGenerator::new, LootContextParamSets.BLOCK);

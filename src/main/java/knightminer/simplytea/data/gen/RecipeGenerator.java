...
public class RecipeGenerator extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		// ingredients
		SimpleCookingRecipeBuilder.smoking(Ingredient.of(SimplyTags.Items.TEA_CROP), black_tea.get(), 0.35f, 200)
	...
	private static void boil(Consumer<FinishedRecipe> consumer, ItemLike cold, ItemLike hot) {
		SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(cold), hot, 0.35f, 900)
	...
	public static void addHoney(Consumer<FinishedRecipe> consumer, ItemLike tea, ItemLike honey, String tag) {
		...
		ResourceLocation advancementId = new ResourceLocation(recipeId.getNamespace(), "recipes/" + SimplyTea.MOD_ID + "/" + recipeId.getPath());

		// build final recipe
		consumer.accept(new ShapelessHoneyRecipe.FinishedHoneyRecipe(recipeId, "simplytea:" + tag, tea, Ingredient.of(honey), tag, advancementId, builder));
	}

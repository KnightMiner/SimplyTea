	...
	protected void start() {
		...
		LootItemCondition[] iceCubesConditions = new LootItemCondition[] {
				LootTableIdCondition.builder(new ResourceLocation("minecraft:blocks/ice"))
					...
					.build(),
				CanToolPerformAction.canToolPerformAction(ToolActions.PICKAXE_DIG).build(),
		...
		this.add("ice_cubes", Registration.ADD_ENTRY_MODIFIER.get(), iceCubesModifier);
		...
		this.add("chorus_petal", Registration.ADD_ENTRY_MODIFIER.get(), petalsModifier);
	}
